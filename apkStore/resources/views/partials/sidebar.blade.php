<div class="nk-aside" data-content="sideNav" data-toggle-overlay="true" data-toggle-screen="lg" data-toggle-body="true">
    <div class="nk-sidebar-menu" data-simplebar>
        <ul class="nk-menu">
            ...
            <li class="nk-menu-item">
                <a href="{{ route('servers.index') }}" class="nk-menu-link">
                    <span class="nk-menu-icon"><em class="icon ni ni-server"></em></span>
                    <span class="nk-menu-text">Manage Servers</span>
                </a>
            </li><!-- .nk-menu-item -->
            <li class="nk-menu-item">
                <a href="{{ route('applications.index') }}" class="nk-menu-link">
                    <span class="nk-menu-icon"><em class="icon ni ni-file"></em></span>
                    <span class="nk-menu-text">Manage Apps</span>
                </a>
            </li><!-- .nk-menu-item -->
            <li class="nk-menu-item">
                <a href="html/manageNotifications.html" class="nk-menu-link">
                    <span class="nk-menu-icon"><em class="icon ni ni-bell"></em></span>
                    <span class="nk-menu-text">Send Notifications</span>
                </a>
            </li><!-- .nk-menu-item -->
            <li class="nk-menu-item">
