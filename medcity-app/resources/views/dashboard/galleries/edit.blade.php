    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-primary">
                ...
                <form action="{{ route('galleries.update', $photo->id) }}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    {{ method_field('put') }}
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name_en" class="form-control" id="exampleInputEmail1"
                                        placeholder="Enter English title" value="{{ $photo->name['en'] }}">
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name_ar" class="form-control" id="exampleInputEmail1"
                                        placeholder="Enter Arabic title" value="{{ $photo->name['ar'] }}">
                                </div>
                            </div>
                        </div>
                    </div>
