        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-header card-header-style">
                    <h3 class="card-title">{{ __('edit_profile') }}</h3>
                </div>
                <!-- /.card-header -->
                <form action="{{ route('profile.update', $editData->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label for="username">{{ __('User Position') }}</label>
                            @if ($editData->role_id == 1)
                                <span class="badge badge-success">Admin</button>
                                @else
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control imageInput" name="image" id="photo">
                            <input type="hidden" name="oldimage" value="{{ $editData->image }}">

                        </div>

                        <div class="form-group">
                            <img src="{{ URL::asset($editData->image) }}"" width="150" class="img-thumbnail img-preview"
                                height="150px">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" name="password_confirmation"
                                ...
                                placeholder="{{ __('enter') . '  ' . __('password_confirmation') }}">
                        </div>

                        <div class="form-group">
                            <label for="phone">{{ __('phone') }}</label>
                            <input type="tel" class="form-control" name="mobile" id="phone"
                                value="{{ $editData->mobile }}" placeholder="{{ __('enter') . '  ' . __('phone') }}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="country" class="form-control" id="country">
                                <option value="{{ $editData->country }}">{{ $editData->country }} </option>
