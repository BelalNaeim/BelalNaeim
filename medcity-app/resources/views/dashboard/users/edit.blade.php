        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header card-header-style">
                    <h3 class="card-title" style="float: left">{{ __('Edit_User') }}</h3>
                    <a href="{{ route('users.index') }}"><button style="float:right" class="btn btn-primary"
                            title="{{ __('show_users') }}"><i class="fa fa-eye"></i></button></a>
                    ...
                    <form action="{{ route('users.update', $user->id) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="name" id="name"
                                value="{{ $user->name }}" placeholder="{{ __('enter') . '  ' . __('name') }}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <img src="{{ URL::to($user->image) }}" style="width: 70px; min-height: 50px;">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" name="email" id="email"
                                value="{{ $user->email }}" placeholder="{{ __('enter') . '  ' . __('email') }}">
                        </div>
