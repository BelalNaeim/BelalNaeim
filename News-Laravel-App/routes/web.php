...
Route::get('/delete/subcategory/{id}', [SubCategoryController::class, 'DeleteٍSubCategory'])->name('delete.subcategory');
...
Route::get('/allposts', [PostController::class, 'index'])->name('all.post');
...
//Live tv Setting
Route::get('/livetv/setting', [SettingController::class, 'LiveTvSetting'])->name('livetvs.setting');
...
//Website Setting
Route::get('all/website/', [SettingController::class, 'AllWebsiteLink'])->name('all.website');
Route::get('add/website/', [SettingController::class, 'AddWebsiteLink'])->name('add.website');
Route::post('/website/store/', [SettingController::class, 'Websitestore'])->name('store.website');
...
Route::post('/photo/store/', [GalleryController::class, 'StorePhoto'])->name('store.photo');
...
Route::post('/video/store/', [GalleryController::class, 'StoreVideo'])->name('store.video');
Route::get('/video/edit/{id}', [GalleryController::class, 'EditVideo'])->name('edit.video');
...
Route::post('/edit/ads', [AdsController::class, 'UpdateAds'])->name('update.ads');
...
Route::get('/show/forms/',function(){
    return view('backend.forms.basic_elements');
})->name('forms.show');
Route::get('/show/tables/',function(){
    return view('backend.tables.basic-table');
})->name('tables.show');
Route::get('/show/charts/',function(){
    return view('backend.charts.chartjs');
})->name('charts.show');
Route::get('/show/icons/',function(){
    return view('backend.icons.mdi');
})->name('icons.show');
