            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="template-demo">
                        @if ($livetv->status == 1)
                            <a href="{{ route('deactive.livetv', $livetv->id) }}"><button type="button"
                                    class="btn btn-danger btn-fw">DeActive</button></a>
                        @else
                    ...
                    <form class="forms-sample" method="POST" action="{{ route('update.livetv', $livetv->id) }}">
                        ...
                        <div class="form-group">
                            <label for="exampleTextarea1">Embeded Code For live </label>
                            <textarea class="form-control" name="embeded_code" id="summernote">
								{{ $livetv->embded_code }}
