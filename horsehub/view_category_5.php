...
<h1 class="pageMainTitle"><?=lang("Trainers", "مدربي خيول"); ?></h1>
	...
	<a href="#" class="producter">
		<div class="producterInfo">
			...
			<div class="producterTexter">
				<span><?=lang("Trainer Name", "اسم المدرب"); ?></span>
...
<?php
	$qu_users_ads_sel = "SELECT * FROM  `users_ads` WHERE ((`category_id` IN (5) ) AND (`ad_status` = 'published'))";
...
?>
	...
	<a href="add_adv.php?typer=5&sub=11&extra_l=0" class="product producterHolder">
