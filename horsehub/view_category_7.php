...
<h1 class="pageMainTitle"><?=lang("Knights", "فارس"); ?></h1>
...
<?php
	$qu_users_ads_sel = "SELECT * FROM  `users_ads` WHERE ((`category_id` IN (6) ) AND (`ad_status` = 'published'))";
...
?>
	...
	<a href="add_adv.php?typer=6&sub=15&extra_l=0" class="product producterHolder">
