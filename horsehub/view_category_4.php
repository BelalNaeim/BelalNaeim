...
<h1 class="pageMainTitle"><?=lang("Veterinary Doctors", "أطباء بيطريين"); ?></h1>
...
<?php
	for( $i=1 ; $i < 2 ; $i++ ){
		...
		$I = 6 ;
?>
	<a href="view_adv.php?adv_id=4" class="producter">
		<div class="producterInfo">
			<img src="uploads/h0<?=$I; ?>.jpg" alt="">
			<div class="producterTexter">
				<span><?=lang("Doctor Name", "اسم الطبيب"); ?></span>
				<span><?=lang("Address", "عنوان العيادة"); ?></span>
...
<?php
	$qu_users_ads_sel = "SELECT * FROM  `users_ads` WHERE ((`category_id` IN (3) ) AND (`ad_status` = 'published'))";
...
?>
	<a href="add_adv.php?typer=3&sub=17&extra_l=0" class="product producterHolder">
