...
<div class="catSelector">
	...
	<div class="cat">
		<span><?=lang("Knight Subscriptions", "إشتراكات الفرسان"); ?></span>
	</div>
	<div class="cat">
		<span><?=lang("for accommodation", "للإيواء"); ?></span>
	</div>
	<div class="cat">
		<span><?=lang("for contest", "المسابقات"); ?></span>
	</div>
	<div class="cat">
		<span><?=lang("Trips", "الرحلات"); ?></span>
	</div>
	<div class="cat">
		<span><?=lang("Occasions Rental", "إيجار للمناسبات"); ?></span>
	</div>
	...
	<a href="view_adv.php?adv_id=2" class="producter">
		<div class="producterInfo">
			...
			<div class="producterTexter">
				<span><?=lang("Advertiser", "اسم المعلن"); ?></span>
				<span><?=lang("Rent", "ايجار"); ?></span>
				<span><?=lang("Horse Booths", "عدد غرف الخيل"); ?></span>
...
<?php
	$qu_users_ads_sel = "SELECT * FROM  `users_ads` WHERE ((`category_id` IN (1) ) AND (`ad_status` = 'published'))";
...
?>
	...
	<a href="add_adv.php?typer=1&sub=1&extra_l=0" class="product producterHolder">
