...
<h1 class="pageMainTitle"><?=lang("Delivery Options / Time and Date", "خيارات التوصيل / الوقت والتاريخ"); ?></h1>
...
<div class="pageCols">
	...
	<div class="detailCol">
		<div class="row">
			...
			<div class="col-1">
				<div class="formGroup">
					<label><?=lang("Select Date", "قم باختيار التاريخ"); ?></label>
					<input type="text" name="ss" id="ss" class="has_date">
				</div>
			</div>
			...
			<div class="col-1">
				<div class="formGroup">
					<label><?=lang("Select Time", "قم باختيار الوقت"); ?></label>
					<input type="text" name="ss" id="ss" class="has_time">
				</div>
			</div>
			...
			<div class="col-2">
				<a href="checkout.php" class="formGroup">
