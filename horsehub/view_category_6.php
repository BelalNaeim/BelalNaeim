...
<h1 class="pageMainTitle"><?=lang("Construction And Contracting", "مقاولات وبناء"); ?></h1>
	...
	<a href="#" class="producter">
		<div class="producterInfo">
			...
			<div class="producterTexter">
				<span><?=lang("Entity Name", "اسم المؤسسة"); ?></span>
				<span><?=lang("License NO.", "رقم الرحصة"); ?></span>
...
?>
	...
	<a href="add_adv.php?typer=1&sub=1" class="product producterHolder">
