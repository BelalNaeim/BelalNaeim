...
--
-- Host: localhost:3306
-- Generation Time: Sep 14, 2022 at 01:19 PM
...
CREATE TABLE `ld_websites` (
  ...
  `website_about` text,
  `website_about_ar` text,
  `website_privacy` text,
  `website_privacy_ar` text,
  `website_terms` text,
  `website_terms_ar` text,
  `pay_policy` text,
  `pay_policy_ar` text,
...
INSERT INTO `subscriptions_plans` (`plan_id`, `plan_name`, `plan_name_ar`) VALUES
(1, 'Subscription for contracting and construction', 'اشتراكات  مقاولات والبناء'),
(2, 'Subscribe to horse equipment', 'اشتراكات عتاد الخيل'),
(3, 'veterinarian subscription', 'اشتراكات البيطري'),
(4, 'Pharmacy and clinic subscription', 'اشتراكات الصيدلية والعيادة'),
(5, 'Subscribe as a knight', 'اشتراكات الفارس'),
(6, 'Subscribe to the stable', 'اشتراكات الإسطبل'),
(7, 'Trainer subscription', 'اشتراكات المدرب'),
(8, 'carriages subscription', 'اشتراكات عربات النقل'),
(9, '\"Feed and cannabis subscription', 'اشتراكات الأعلاف والحشيش');
...
--
-- Dumping data for table `subscriptions_plans_types`
--

INSERT INTO `subscriptions_plans_types` (`type_id`, `type_name`, `type_name_ar`, `type_price`, `plan_id`) VALUES
(1, '1 week subscription\r\n', 'اشتراك لمدة أسبوع', '15 AED', 6),
(2, '1 month subscription\r\n', 'اشتراك لمدة شهر', '60 ِAED', 6),
(3, '6 month subscription\r\n', 'اشتراك لمدة 6 شهور', '324 AED', 6),
(4, '1 week subscription', 'اشتراك لمدة أسبوع', '10 AED', 7),
(5, '1 month subscription', 'اشتراك لمدة شهر', '40 AED', 7),
(6, '1 week subscription\r\n', 'اشتراك لمدة أسبوع\r\n', '10 AED', 5),
(7, '1 month subscription\r\n', 'اشتراك لمدة شهر\r\n', '40 AED', 5),
(8, '1 week subscription\r\n', 'اشتراك لمدة أسبوع', '50 AED', 4),
(9, '1 month subscription\r\n', 'اشتراك لمدة شهر', '200 AED', 4),
(10, '6 month subscription\r\n', 'اشتراك لمدة 6 شهور\r\n', '1080 AED', 4),
(11, '1 week subscription\r\n', 'اشتراك لمدة أسبوع', '15 AED', 8),
(12, '1 month subscription\r\n', 'اشتراك لمدة شهر', '60 AED', 8),
(13, '1 week subscription\r\n', 'اشتراك لمدة أسبوع', '15 AED', 9),
(14, '1 month subscription\r\n', 'اشتراك لمدة شهر', '60 AED', 9),
(15, '1 week subscription\r\n', 'اشتراك لمدة أسبوع', '25 AED', 3),
(16, '1 month subscription\r\n', 'اشتراك لمدة شهر', '100 AED', 3),
(17, '1 week subscription\r\n', 'اشتراك لمدة أسبوع', '25 AED', 1),
(18, '1 month subscription\r\n', 'اشتراك لمدة شهر', '100 AED', 1),
(19, '6 month subscription\r\n', 'اشتراك لمدة 6 شهور', '540 AED', 1),
(20, '1 week subscription\r\n', 'اشتراك لمدة أسبوع', '30 AED', 2),
(21, '1 month subscription\r\n', 'اشتراك لمدة شهر', '120 AED', 2),
(22, '6 month subscription\r\n', 'اشتراك لمدة 6 شهور', '648 AED', 2),
(23, '1 year subscription\r\n', 'اشتراك لمدة سنة', '1080 AED', 2);
...
(20, 'Blaine Alford', 'mimeficiko@mailinator.com', '+1 (675) 496-4687', 'f3ed11bbdb94fd9ebdefbaf646ab94d3', 'Delectus pariatur', 0, 0, 0, 0, 0, 0, 0, 1);
...
--
-- Constraints for table `subscriptions_plans_types`
--
ALTER TABLE `subscriptions_plans_types`
  ADD CONSTRAINT `sup_plan_type` FOREIGN KEY (`plan_id`) REFERENCES `subscriptions_plans` (`plan_id`);
COMMIT;
