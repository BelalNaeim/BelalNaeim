...
<h1 class="pageMainTitle"><?=lang("Address Information", "قم بادخال العنوان"); ?></h1>
...
<div class="pageCols">
	...
	<div class="detailCol">
		<div class="row">
			<div class="col-1">
				<div class="formGroup">
					<label><?=lang("Enter or select the location on the map from the address selector button", "قم بادخال الموقع أو اختياره على الخريطة من الزر المجاور"); ?></label>
				</div>
			</div>
			
			<div class="col-1">
				<div class="formGroup">
					<label><?=lang("Location", "العنوان"); ?></label>
