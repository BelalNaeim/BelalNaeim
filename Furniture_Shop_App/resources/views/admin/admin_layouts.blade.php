     ...
     @else
         ...
         <div class="sl-sideleft">
             ...
             <div class="sl-sideleft-menu">
                 ...
                 <ul class="sl-menu-sub nav flex-column">
                     <li class="nav-item"><a href="{{ route('add.product') }}" class="nav-link"><i
                                 class="fa fa-product-hunt" aria-hidden="true"></i> Add Product</a></li>
                     <li class="nav-item"><a href="{{ route('all.product') }}" class="nav-link"><i
                                 class="fa fa-shopping-cart" aria-hidden="true"></i> All product</a></li>
                 </ul>
                 ...
                 <ul class="sl-menu-sub nav flex-column">
                     ...
                     <li class="nav-item"><a href="{{ route('slider.all') }}" class="nav-link">All Sliders </a>
                     </li>
                 ...
                 <ul class="sl-menu-sub nav flex-column">
                     <li class="nav-item"><a href="{{ route('admin.site.setting') }}" class="nav-link">Site
                             Setting</a></li>
                 ...
                 <nav class="nav">
                     <div class="dropdown">
                         <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
                             ...
                             <img src="{{ asset('backend/img/img3.jpg') }} " class="wd-32 rounded-circle"
                                 alt="">
                         </a>
                         ...
                         <a href="" class="media-list-link">
                             <div class="media">
                                 ...
                                 <div class="media-body">
                                     ...
                                     <p class="tx-13 mg-t-10 mg-b-0">I should be incapable of drawing a single stroke at
